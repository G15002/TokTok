...
import 'gender.dart';
class FavouriteSurvey extends StatefulWidget {
  const FavouriteSurvey({super.key});
 // final String title;

  @override
  State<FavouriteSurvey> createState() => _FavouriteSurveyState();
}


class _FavouriteSurveyState extends State<FavouriteSurvey> {
